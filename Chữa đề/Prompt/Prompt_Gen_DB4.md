Phân tích toàn bộ bài làm tiếng Nhật và xuất Markdown thuần cho Obsidian gồm: Summary, Error Analysis, Knowledge Extracted, Learning Profile, Weak Points, Action Next dựa vào template từ file TemplateNoteBookLM (không phân tích lại file này).
...
Ưu tiên phân tích nguyên nhân chọn sai, nhóm lỗi (Grammar Confusion, Trigger, Register, Logic...), chỉ ra dấu hiệu nhận biết (Trigger), bẫy đề và cách phân biệt để tránh lặp lại lỗi.
