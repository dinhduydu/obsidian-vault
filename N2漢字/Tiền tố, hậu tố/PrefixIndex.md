...
### Mức độ
 ...
 │   ├─ 準 (Chuẩn): Gần bằng, chưa chính thức (Vd: 準決勝 - bán kết, 準社員 - nhân viên dự bị)
 │   ├─ 悪 (Ác): Xấu, tệ (Vd: 悪影響 - ảnh hưởng xấu, 悪条件 - điều kiện bất lợi)
 │   ├─ 好 (Hảo): Tốt, thuận lợi (Vd: 好景気 - kinh tế thuận lợi)
 │   ├─ 硬 (Ngạnh): Cứng (Vd: 硬着陸 - hạ cánh cứng)
 │   ├─ 軟 (Nhuyễn): Nhẹ nhàng, an toàn (Vd: 軟着陸 - hạ cánh an toàn)
...
### Thời gian
 ...
 │   ├─ 来 (Lai): Tới, sau (Vd: 来学期 - học kỳ tới)
 │   ├─ 翌 (Dực): Tiếp theo (Vd: 翌朝 - sáng hôm sau)
 │   ├─ 明 (Minh): Tiếp theo (Vd: 明朝 - sáng mai)
...
### Số lượng 
 ...
 │   ├─ 諸 (Chư): Các, những (Vd: 諸外国 - các nước khác)
 │   ├─ 数 (Số): Một vài (Vd: 数時間 - vài giờ)
 │   ├─ 両 (Lưỡng): Hai (Vd: 両手 - hai tay, 両大陸 - hai châu lục)
